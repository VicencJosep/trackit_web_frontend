        ...
        <div className={styles.grid}>
          {packets.map((packet, index) => (
            <div key={index} className={styles.card}>
              ...
              <p>
                <strong>{String(t('store.status'))}:</strong>{' '}
                {String(t(`store.status_${packet.status}`))}
              </p>
              <p>
              ...
              <button className={styles.buyButton} onClick={() => handleBuyClick(packet)}>
                {String(t('store.buy'))}
              </button>
            </div>
          ))}
        ...
        >
          <div style={{ background: 'white', padding: 20, borderRadius: 8 }}>
            ...
            <div style={{ marginTop: 10 }}>
              ...
              <button onClick={() => setShowAddressInput(false)} style={{ marginLeft: 10 }}>
                Cancelar
              </button>
